...
insert into transportadora(email, nome, empresa, telefone, modal, celular, whats_app, endereco_id)
    values ('teste@email.com', 'NomeFantasia', 'Nome da empresa', '8131112233', 'AEREO', null, null, 2);
select * from endereco;

insert into endereco(rua, numero, bairro, cidade, estado, cep)
    values('R fulano', 30, 'Antigo', 'Recife', 'AC', null);

insert into transportadora(email, nome, empresa, telefone, modal, celular, whats_app, endereco_id)
    values ('teste@email.com', 'NomeFantasia', 'Nome da empresa', '8131112233', 'AEREO', null, null, 3);
select * from endereco;